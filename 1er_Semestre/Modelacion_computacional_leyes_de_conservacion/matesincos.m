...
%eq3 = a*sin(0.01*12)+b*cos(0.01*12)+c*sin(2*(0.001)*12)+d*cos(2*(0.01)*12) == -2.08326;
%eq3 = (a*cos(12/100))/100 - (d*sin(12/50))/50 - (b*sin(12/100))/100 + (c*cos(12/500))/500 == -2.08326;
%eq3= a*sin(0.01*34)+b*cos(0.01*34.999)+c*sin(2*(0.001)*34.999)+d*cos(2*(0.01)*34.999) == -2.08326;

%eq4 = 0.01 * a * cos(0.35) - 0.01 * b * sin(0.35) + 0.02 * c * cos(0.7) - 0.02 * d * sin(0.7) == 2.8659988;
%eq4 = a*sin(0.01*35)+b*cos(0.01*35)+c*sin(2*(0.001)*35)+d*cos(2*(0.01)*35) == 2.8659988;
%eq4 = (a*cos(35/100))/100 - (d*sin(35/50))/50 - (b*sin(35/100))/100 + (c*cos(35/500))/500 == 2.8659988;
%eq4=(a*cos((1/100)*35)-b*sin((1/100)*35))/100+((c*cos((1/500)*35))/500)-(d*sin((1/50)*35)/50);
